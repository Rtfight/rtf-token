...
export interface PointPayTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addToBlockList"
      | "allowance"
...
export interface PointPayToken extends BaseContract {
  connect(runner?: ContractRunner | null): PointPayToken;
  waitForDeployment(): Promise<this>;

  interface: PointPayTokenInterface;
  ...
  isBlocklisted: TypedContractMethod<[arg0: AddressLike], [boolean], "view">;
