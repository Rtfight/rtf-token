...
export declare namespace ClaimERC2771Forwarder {
...
export interface ClaimERC2771ForwarderInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "eip712Domain"
      | "execute"
  ...
  encodeFunctionData(
    ...
    values: [ClaimERC2771Forwarder.ForwardRequestDataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "executeBatch",
    values: [ClaimERC2771Forwarder.ForwardRequestDataStruct[], AddressLike]
  ): string;
...
export interface ClaimERC2771Forwarder extends BaseContract {
  connect(runner?: ContractRunner | null): ClaimERC2771Forwarder;
  waitForDeployment(): Promise<this>;

  interface: ClaimERC2771ForwarderInterface;
  ...
  execute: TypedContractMethod<
    [request: ClaimERC2771Forwarder.ForwardRequestDataStruct],
    [void],
    "payable"
  >;
  ...
  executeBatch: TypedContractMethod<
    [
      requests: ClaimERC2771Forwarder.ForwardRequestDataStruct[],
